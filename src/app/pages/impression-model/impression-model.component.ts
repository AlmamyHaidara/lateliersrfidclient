...
@Component({
  ...
  templateUrl: './impression-model.component.html',
  styleUrls: ['./impression-model.component.css']
})
export class ImpressionModelComponent implements OnInit {
