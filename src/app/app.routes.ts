...
import { CommandeHistoryListComponent } from './pages/commandeHistory/commande-history-list/commande-history-list.component';
...
export const routes: Routes = [
  ...
  {
    path: 'ListColor/:collectionId',
    component: ListColorComponent,
    canActivate: [authGuard],
  },
  {
    path: 'list-dim/:collectionId/:gammeId',
    component: ListDimensionsComponent,
    canActivate: [authGuard],
  },
  {
    path: 'association/:art_id',
  ...
  { path: 'AlertCreateSociety', component: CreateSocietyAlertComponent },
  { path: 'AdminCompte', component: AdminCompteComponent },
  { path: 'AddNewEmployee', component: AddSousCompteComponent },
  {
    path: 'ListSousCompte',
    component: ListSousCompteComponent,
    canActivate: [authGuard],
  },
  {
    path: 'editEmploye/:id',
    component: EditSousCompteComponent,
    canActivate: [authGuard],
  },
  { path: 'aides', component: ParametersComponent, canActivate: [authGuard] },
  {
    path: 'parameters',
    component: ParametersCurrentCompteComponent,
    canActivate: [authGuard],
  },
  {
    path: 'informations',
  ...
  {
    path: 'adresse',
    component: AdresseLivraisionComponent,
    canActivate: [authGuard],
  },
  ...
  {
    path: 'commandeModal',
    component: ModalCommandeComponent,
    canActivate: [authGuard],
  },
  {
    path: 'listHistory',
    component: CommandeHistoryListComponent,
    canActivate: [authGuard],
  },
  {
    path: 'etatCommande',
    component: CommandeStateComponent,
    canActivate: [authGuard],
  },
  ...
  {
    path: 'addAdress',
    component: AddAdressFormComponent,
    canActivate: [authGuard],
  },
  ...
  {
    path: 'impression',
    component: ImpressionModelComponent,
    canActivate: [authGuard],
  },
  ...
  {
    path: 'comment',
    component: CommentaireByOrderComponent,
    canActivate: [authGuard, commentsGuard],
  },
